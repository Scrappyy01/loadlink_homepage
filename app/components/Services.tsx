...
const services = [
  ...
  },
  {
    ...
    description:
      "Find available freight near you. Access real-time listings and maximize return trips.",
    cta: "View Loadboard",
    ...
    >
      <div className="max-w-6xl mx-auto px-[5%] md:px-[8%] relative z-10">
        ...
        <div className="text-center mb-14 reveal">
          <span className="text-loadlink-orange text-xs font-bold tracking-widest uppercase mb-3 block">
            Our Services
          </span>
          <h2 className="text-5xl md:text-6xl font-bold text-loadlink-navy leading-tight mb-4">
            Three ways to ship
            <br />
            <span className="text-gray-400">One platform</span>
          </h2>
          <p className="text-gray-500 text-lg max-w-xl mx-auto">
            Whether it&apos;s a parcel, pallet, or full load choose the service
            that fits.
          </p>
        </div>
            ...
            >
              <div className="relative z-10 flex items-center gap-6 md:gap-10 p-6 md:p-6">
                ...
                <div className="flex-1 min-w-0">
                  <h3
                    className={`text-xl md:text-2xl font-bold ${service.titleColor} mb-1 transition-colors duration-500`}
                  >
                    {service.title}
                  </h3>
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                  <span
                    className={`text-sm font-semibold ${service.ctaColor} transition-colors duration-500 hidden lg:block`}
                  >
                    {service.cta}
                  </span>
                  <div
                    className={`w-10 h-10 rounded-full border-2 ${service.borderColor} ${service.hoverBorder} bg-white flex items-center justify-center transition-all duration-500`}
                  >
                    <svg
                      className={`w-4 h-4 ${service.ctaColor} transition-all duration-500 group-hover:translate-x-0.5`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
              ...
              {/* Bottom accent line */}
              <div
                className={`absolute bottom-0 left-0 h-[2px] w-0 group-hover:w-full bg-gradient-to-r ${service.accentLine} transition-all duration-700`}
              />
            </Link>
          ))}
        </div>
