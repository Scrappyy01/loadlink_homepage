...
const integrations = [
  {
    ...
    description: "Connect your Shopify store for automated shipping.",
    featured: true,
  },
  {
    src: "/images/woocommerce.webp",
    alt: "WooCommerce",
    comingSoon: false,
    href: "/integrations/woocommerce",
    description: "Seamless WooCommerce plugin with live rates.",
    featured: true,
  },
  {
    src: "/images/ebay.svg",
    alt: "Ebay",
    comingSoon: true,
    description: "eBay marketplace integration coming soon.",
  },
  {
    src: "/images/ShipStation_Logo_0.svg",
    alt: "Shipstation",
    comingSoon: true,
    description: "ShipStation connection in development.",
  },
  {
    src: "/images/Shippo.png",
    alt: "Shippo",
    comingSoon: true,
    description: "Shippo integration on the roadmap.",
  },
  {
    src: "/images/Maropost.png",
    alt: "Maropost",
    comingSoon: true,
    description: "Maropost/Neto support coming soon.",
  },
];
...
export default function ConnectEcommerce() {
  ...
  return (
    <section
      id="connect-ecommerce"
      className="py-24 md:py-32 px-[5%] md:px-[8%] bg-gray-50"
      ref={ref}
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 stagger-children">
          {integrations.map((item, index) => {
            const Card = (
              <div
                className={`group relative bg-white rounded-2xl p-6 border transition-all duration-500 flex flex-col items-center text-center h-full ${
                  item.comingSoon
              ...
              >
                ...
                <h3 className="text-lg font-bold text-loadlink-navy mb-2">
                  {item.alt}
                </h3>
