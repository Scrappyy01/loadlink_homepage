...
export default function PromoBanner() {
  ...
  return (
    <section className="py-12 md:py-16 px-[5%] md:px-[8%] bg-white" ref={ref}>
        ...
        <div className="relative bg-gradient-to-br from-[#fef3e8] to-[#fde8d3] rounded-3xl overflow-hidden">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="flex-1 p-7 md:p-10 z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-loadlink-navy leading-tight mb-3">
                Up to 47% off*
                <br />
                for shipping
              </h2>
              <p className="text-xl text-loadlink-navy/70 mb-6">
                You Bet! It&apos;s called{" "}
            ...
            <div className="flex-1 flex justify-end items-end self-end">
              <Image
                src="/images/men_laodlink.png"
                alt="Loadlink team member"
                width={420}
                height={420}
                className="max-h-[420px] block drop-shadow-lg"
              />
            </div>
          </div>
        </div>
