    ...
    <>
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <section
          ...
          style={{
            background: "linear-gradient(180deg, #0B1E3F 0%, #132B55 100%)",
          }}
        >
            ...
            <div className="flex items-center justify-between flex-wrap gap-8">
              <div className="flex-1 min-w-[300px]">
                ...
                <p className="text-white/80 text-sm mb-6">
                  Target Audience: Store Administrators, Fulfillment Teams, and
                  Shop Managers
                </p>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-loadlink-orange">
                <div className="flex items-center gap-3 mb-2">
                  <svg
                    className="w-8 h-8 text-loadlink-orange"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
                ...
                <p className="text-gray-600">
                  Get started in under 10 minutes with our guided setup
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-green-500">
                ...
                <p className="text-gray-600">
                  Automatic freight booking and manifest generation
                </p>
              </div>
            </div>
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-700 text-lg leading-relaxed mb-4">
                The Loadlink Shopify Application is a professional integration
                middleware designed to bridge Shopify storefronts with the
                Loadlink freight platform. The application facilitates{" "}
                <strong>real-time logistics management</strong>, providing
                automated freight rate calculations during checkout and
                streamlined order fulfillment workflows directly within the
                Shopify Admin.
              </p>
            </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-loadlink-orange">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start gap-3">
                      <span className="text-loadlink-orange font-bold">•</span>
                      <div>
                        <strong className="text-gray-800">Shopify CLI:</strong>{" "}
                        <span className="text-gray-700">
                          For app management
                        </span>
                      </div>
                    ...
                    <li className="flex items-start gap-3">
                      <span className="text-loadlink-orange font-bold">•</span>
                      <div>
                        <strong className="text-gray-800">Git:</strong>{" "}
                        <span className="text-gray-700">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-gray-700">
                          For app distribution and API access
                        </span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <strong className="text-gray-800">
                          Loadlink Credentials:
                        </strong>{" "}
                        <span className="text-gray-700">
                          API Key, Secret, and User ID
                        </span>
                      </div>
                    </li>
                  </ul>
            ...
            <div className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-loadlink-orange">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="flex items-center justify-center w-10 h-10 rounded-full bg-loadlink-orange text-white font-bold text-lg">
                      1
                    </span>
                  ...
                  <p className="text-gray-700 text-sm">
                    During checkout, real-time freight rates are calculated
                    based on cart weight, dimensions, and delivery location
                    using the Loadlink API.
                  </p>
                </div>

                <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-blue-500">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="flex items-center justify-center w-10 h-10 rounded-full bg-blue-500 text-white font-bold text-lg">
                      2
                    </span>
                    <h3 className="text-lg font-semibold text-gray-800">
                      Order Automation
                  ...
                  <p className="text-gray-700 text-sm">
                    When an order is paid, webhooks automatically trigger
                    freight booking in Loadlink and store the Freight ID in
                    Shopify metafields.
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-green-500">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="flex items-center justify-center w-10 h-10 rounded-full bg-green-500 text-white font-bold text-lg">
                      3
                    </span>
                    <h3 className="text-lg font-semibold text-gray-800">
                      Admin Control
                  ...
                  <p className="text-gray-700 text-sm">
                    Centralized dashboard in Shopify Admin for managing API
                    credentials, defaults, and system logging preferences.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-8 border border-gray-200">
                <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
                  <svg
                    className="w-5 h-5 text-loadlink-orange"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
                ...
                >
                  <div className="flex items-center gap-4">
                    <span className="flex items-center justify-center w-10 h-10 rounded-full bg-loadlink-orange text-white font-bold">
                      1
                    </span>
                    <h2 className="text-2xl font-bold text-gray-800">
                      Create a Shopify Store (Testing Environment)
                    </h2>
                  </div>
                  <svg
                  ...
                  <div className="px-6 py-5 border-t border-gray-200 bg-gray-50">
                    <div className="bg-white p-4 rounded-lg mb-4 border-l-4 border-loadlink-orange">
                      ...
                      <p className="text-gray-700 mb-3">
                        Go to the <strong>Shopify Partner portal</strong> and
                        create an account. You need this because:
                      </p>
                      <ul className="space-y-2 ml-4">
                        <li className="flex items-start gap-3">
                          <span className="text-loadlink-orange font-bold">
                            •
                          </span>
                          <span className="text-gray-700">
                            Carrier Service integrations require an app
                          </span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="text-loadlink-orange font-bold">
                          ...
                          <span className="text-gray-700">
                            Apps are created inside the Partner dashboard
                          </span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="text-loadlink-orange font-bold">
                          ...
                          <span className="text-gray-700">
                            You can create unlimited dev stores
                          </span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-lg mb-4 border-l-4 border-blue-500">
                      ...
                      <p className="text-gray-700 mb-2">
                        Inside the Partner dashboard:
                      </p>
                      <ol className="space-y-1 ml-4 list-decimal list-inside text-gray-700 mb-3">
                        <li>
                          Click <strong>Stores</strong>
                        </li>
                        <li>
                          Click <strong>Add store</strong>
                        </li>
                        <li>
                          Choose <strong>Development store</strong>
                        </li>
                        <li>
                          Give it a name (e.g.{" "}
                    ...
                    <div className="bg-white p-4 rounded-lg border-l-4 border-yellow-500">
                      <h3 className="text-xl font-semibold text-gray-800 mb-3">
                        Step 3: Upgrade Plan (Important for Carrier Services)
                      </h3>
                      <p className="text-gray-700 mb-2">
                        Shopify only allows Carrier Service apps on:
                      </p>
                      <ul className="space-y-1 ml-4 mb-3">
                        ...
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700">Shopify Plus</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="text-loadlink-orange font-bold">
                            •
                          ...
                          <span className="text-gray-700">
                            Or stores with real-time carrier shipping enabled
                          </span>
                        </li>
                      </ul>
                      <div className="bg-yellow-50 border border-yellow-200 rounded p-3">
                        <p className="text-gray-700 text-sm">
                          <strong>For dev stores:</strong> You can enable
                          real-time carrier shipping manually in settings. If
                          testing fails later, this is usually why.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800">
                      Set Up the Loadlink Shopify App
                    </h2>
                  </div>
                  <svg
                  ...
                  <div className="px-6 py-5 border-t border-gray-200 bg-gray-50">
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                      <p className="text-blue-800 text-sm font-semibold">
                        This is NOT a theme plugin. It's a Shopify App that runs
                        externally.
                      </p>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-lg mb-4 border-l-4 border-loadlink-orange">
                      ...
                      <ul className="space-y-1 ml-4 mb-3">
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700">Node.js 18+</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="text-loadlink-orange font-bold">
                            •
                        ...
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700">Shopify CLI</span>
                        </li>
                      </ul>
                    ...
                    <div className="bg-white p-4 rounded-lg mb-4 border-l-4 border-green-500">
                      <h3 className="text-xl font-semibold text-gray-800 mb-3">
                        Step 6: Create Shopify App via CLI
                      </h3>
                      <p className="text-gray-700 mb-2">
                        From inside the project folder:
                      </p>
                      <pre className="bg-gray-900 text-green-400 p-3 rounded-lg text-sm overflow-x-auto mb-3">
                        shopify app dev
                      </pre>
                      <p className="text-gray-700 mb-2">
                      ...
                      <ul className="space-y-1 ml-4">
                        ...
                        <li className="flex items-start gap-3">
                          <span className="text-green-500 font-bold">✓</span>
                          <span className="text-gray-700">
                            Creates the app in your Partner dashboard
                          </span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="text-green-500 font-bold">✓</span>
                        ...
                        <li className="flex items-start gap-3">
                          <span className="text-green-500 font-bold">✓</span>
                          <span className="text-gray-700">
                            Installs the app into your dev store
                          </span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-lg mb-4 border-l-4 border-purple-500">
                      ...
                      <ul className="space-y-1 ml-4 mb-3">
                        ...
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700">Sets up SQLite</span>
                        </li>
                      </ul>
                    ...
                    <div className="bg-white p-4 rounded-lg border-l-4 border-yellow-500">
                      ...
                      <ul className="space-y-1 ml-4">
                        ...
                        <li className="flex items-start gap-3">
                          <span className="text-green-500 font-bold">✓</span>
                          <span className="text-gray-700">
                            Connects Shopify to your local machine
                          </span>
                        </li>
                      </ul>
                    </div>
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800">
                      Configure the App Inside Shopify
                    </h2>
                  </div>
                  <svg
                ...
                {openSection === "settings" && (
                  <div className="px-6 py-5 border-t border-gray-200 bg-gray-50">
                    <div className="bg-white p-4 rounded-lg mb-4 border-l-4 border-loadlink-orange">
                      <h3 className="text-xl font-semibold text-gray-800 mb-3">
                        Step 9: Install the App in Store
                      </h3>
                      <p className="text-gray-700 mb-2">
                        If CLI didn't auto-install:
                      </p>
                      <ol className="space-y-1 ml-4 list-decimal list-inside text-gray-700">
                        <li>
                          Go to <strong>Shopify Admin</strong>
                        </li>
                        <li>
                          Apps → <strong>Develop Apps</strong>
                        </li>
                    ...
                    <div className="bg-white p-4 rounded-lg border-l-4 border-blue-500">
                      <h3 className="text-xl font-semibold text-gray-800 mb-3">
                        Step 10: Enter Loadlink API Credentials
                      </h3>
                      <p className="text-gray-700 mb-3">
                          ...
                          <tbody className="divide-y divide-gray-200">
                            <tr>
                              ...
                              <td className="px-4 py-3 text-gray-700">
                                Your unique API key from Loadlink
                              </td>
                            </tr>
                            <tr>
                              <td className="px-4 py-3 font-medium text-gray-800">
                              ...
                              <td className="px-4 py-3 text-gray-700">
                                Your API secret provided by Loadlink
                              </td>
                            </tr>
                            <tr>
                              <td className="px-4 py-3 font-medium text-gray-800">
                ...
                {openSection === "setup" && (
                  <div className="px-6 py-5 border-t border-gray-200 bg-gray-50">
                    ...
                    <div className="bg-white p-4 rounded-lg mb-4 border-l-4 border-green-500">
                      ...
                      <p className="text-gray-700 mb-2">
                        You should see <strong>Loadlink Carrier Service</strong>
                        . Enable it for your shipping zone.
                      </p>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-lg border-l-4 border-red-500">
                      ...
                      <ul className="space-y-2 ml-4">
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700">
                            Carrier Service may not be properly registered
                          </span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="text-red-500 font-bold">•</span>
                          <span className="text-gray-700">
                            Plan may not support real-time carrier shipping
                          </span>
                        </li>
                      </ul>
                    </div>
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800">
                      Test Checkout Rate Calculation
                    </h2>
                  </div>
                  <svg
                ...
                {openSection === "freight" && (
                  <div className="px-6 py-5 border-t border-gray-200 bg-gray-50">
                    <div className="bg-white p-4 rounded-lg mb-4 border-l-4 border-loadlink-orange">
                      ...
                      <ul className="space-y-2 ml-4">
                        ...
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700">Add weight</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="text-loadlink-orange font-bold">
                            •
                      ...
                      <div className="bg-yellow-50 border border-yellow-200 rounded p-3 mt-3">
                        <p className="text-sm text-gray-700">
                          <strong>Note:</strong> Weight is important because
                          freight quotes depend on it.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-lg border-l-4 border-blue-500">
                      <h3 className="text-xl font-semibold text-gray-800 mb-3">
                        Step 12: Go Through Checkout
                      </h3>
                      <ol className="space-y-1 ml-4 list-decimal list-inside text-gray-700 mb-3">
                        <li>Add product to cart</li>
                        <li>Enter shipping address</li>
                        <li>
                          At shipping step, Shopify sends a request to{" "}
                          <code className="bg-gray-100 px-1 rounded">
                            /api/rates
                          </code>
                        </li>
                      ...
                      <div className="bg-green-50 border border-green-200 rounded p-3">
                        <p className="text-sm text-green-800">
                          ...
                          <strong>Loadlink freight options</strong> at checkout.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
                ...
                {openSection === "individual" && (
                  <div className="px-6 py-5 border-t border-gray-200 bg-gray-50">
                    ...
                    <div className="bg-white p-4 rounded-lg mb-4 border-l-4 border-blue-500">
                      <h3 className="text-xl font-semibold text-gray-800 mb-3">
                        Step 14: Webhook Trigger
                      </h3>
                      <p className="text-gray-700 mb-2">
                        When order is paid, Shopify sends{" "}
                        <code className="bg-gray-100 px-1 rounded">
                          orders/paid
                        </code>
                        . Your app then:
                      ...
                      <ul className="space-y-1 ml-4 mb-3">
                        <li className="flex items-start gap-3">
                          <span className="text-green-500 font-bold">✓</span>
                          <span className="text-gray-700">Calls Loadlink</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="text-green-500 font-bold">✓</span>
                          <span className="text-gray-700">
                        ...
                        <li className="flex items-start gap-3">
                          <span className="text-green-500 font-bold">✓</span>
                          <span className="text-gray-700">
                            Stores Freight ID in metafields
                          </span>
                        </li>
                      </ul>
                      ...
                      <ul className="space-y-1 ml-4">
                        ...
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700">
                            Loadlink dashboard → Shipment created
                          </span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-lg border-l-4 border-purple-500">
                      ...
                      <p className="text-gray-700 mt-3 mb-2 text-sm">
                        Your app must be hosted somewhere in production. Common
                        hosting options:
                      </p>
                      <ul className="space-y-1 ml-4">
                        <li className="flex items-start gap-3">
