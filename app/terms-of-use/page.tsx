...
export const metadata: Metadata = {
  title: 'Terms of Use',
  description:
    'Read the LoadLink Terms of Use and Privacy Policy. Understand how we handle your data, your rights, and the conditions governing use of our platform.',
  alternates: {
    canonical: '/terms-of-use',
  },
  openGraph: {
    title: 'Terms of Use | LoadLink Australia',
    description:
      'Read the LoadLink Terms of Use and Privacy Policy governing use of our freight and logistics platform.',
    url: 'https://www.loadlink.com.au/terms-of-use',
  },
};
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-gray-600 leading-relaxed">
        <div>
          <p className="font-semibold text-loadlink-navy">Inconsistencies</p>
          <p>If any terms in this document conflict with other terms displayed on Our Website, the more specific terms prevail to the extent of the inconsistency.</p>
        </div>
        <div>
          <p className="font-semibold text-loadlink-navy">No Waiver</p>
          <p>If We do not act in relation to a breach of the Terms of Use by You, We do not waive any rights to act in relation to that breach or any later breach by You. Likewise, if You do not act in relation to a breach by Us, You do not waive any rights.</p>
        </div>
        <div>
          <p className="font-semibold text-loadlink-navy">Privacy and Personal Information</p>
          <p>Any personal information collected by Us through the Services will be handled in accordance with Our Privacy Policy.</p>
        </div>
        <div>
          <p className="font-semibold text-loadlink-navy">Severability</p>
        ...
        <div>
          <p className="font-semibold text-loadlink-navy">Governing Law</p>
          <p>The Terms of Use are governed by the laws in force in Queensland, Australia. You and We submit to the non-exclusive jurisdiction of the courts of Queensland and waive any claim or objection based on absence of jurisdiction or inconvenient forum.</p>
        </div>
      </div>
    ),
  },
    ...
    <>
      ...
      <section className="py-24 px-[5%] md:px-[8%] bg-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-loadlink-navy mb-5">Have questions about our policies?</h2>
          <p className="text-gray-500 text-lg mb-8">
            Our team is happy to clarify anything in our Terms of Use or Privacy Policy.
          </p>
